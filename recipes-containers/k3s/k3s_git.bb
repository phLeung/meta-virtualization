...
SRC_URI = "git://github.com/rancher/k3s.git;branch=release-1.26;name=k3s;protocol=https \
           file://k3s.service \
...
SRCREV_k3s = "6c6745b15e1e93fec257e75900b91d6e2de4d11c"

SRCREV_FORMAT = "k3s_fuse"
PV = "v1.26.6+k3s1+git${SRCREV_k3s}"
